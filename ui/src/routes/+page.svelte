        ...
        <div class="space-y-1.5 pt-0.5">
          {#each INFRA_KINDS as k}
            <label class="flex items-center gap-2.5 cursor-pointer group">
              <input type="checkbox" bind:group={infraEnabledKindsDraft} value={k.id}
      ...
      <div class="rounded-md border border-border bg-muted/70 p-3 space-y-2">
          ...
          <ul class="space-y-1 pt-0.5">
            {#each infraFrontendTargetsDraft as target (target.id)}
              <li class="flex items-center gap-2 group">
                ...
                <button type="button" onclick={() => removeFrontendTarget(target.id)}
        ...
        <div class="flex items-center gap-1.5 pt-0.5">
          <input type="text" bind:value={newTargetName}
            onkeydown={(e) => { if (e.key === "Enter") addFrontendTarget(); }}
            placeholder="Name"
          ...
          <button type="button" onclick={addFrontendTarget}
